    ...
    <div class="flex flex-col">
      ...
      <div class="md:w-2/3 m-auto mt-7 text-center">
        ...
        <div class="flex gap-5 mt-5 justify-center">
          @auth
          <a class="rounded-lg py-2 px-3 bg-[#e00024] hover:bg-[#FF9684] text-xl font-semibold text-white"
            href="/aboutus">
            Tentang Kami
          </a>
          @else
    ...
    <div class="flex flex-col gap-10">
      ...
      <div class="flex flex-col md:flex-row m-auto gap-14 md:items-start">
        <a class="flex flex-col md:w-1/3 text-center" href="/crafts">
          <div
            class="bg-white w-fit px-4 py-2 rounded-lg shadow-md text-7xl m-auto hover:bg-[#e00024] hover:text-white">
      ...
      <div class="w-3/4 self-center text-center bg-white shadow-lg p-5 rounded-lg flex md:flex-row flex-col gap-2">
        {{-- <img src={{ asset('img/KetuaDekranasdaKBB.jpg')}} alt="Ketua Dekranasda KBB"
          class="w-80 rounded-full m-auto" /> --}}
        <div class="md:text-xl font-semibold m-auto md:p-5 p-2">
          ...
          <p class="text-base">
            - Sonya Fatmala (Ketua Dekranasda KBB Periode 2018-2023) -
          </p>
        </div>
      </div>
    </div>
